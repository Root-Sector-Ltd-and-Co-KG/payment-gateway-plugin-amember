...
test("aMember release is manually dispatched for an exact source and version", () => {
...
test("every action in the aMember release workflow is pinned to a reviewed commit", () => {
